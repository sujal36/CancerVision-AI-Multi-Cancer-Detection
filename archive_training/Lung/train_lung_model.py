...
# -------- SETTINGS --------
BASE_DIR = r"E:\FINAL Year Project Protoypes\CancerXrayWebAppMain7\dataset\Lung"

MODEL_DIR = r"E:\FINAL Year Project Protoypes\CancerXrayWebAppMain7\models\Lung"
...
# -------- SAVE LABEL MAP --------
with open(os.path.join(MODEL_DIR, "lung_labels.json"), "w") as f:
...
MODEL_OUT = os.path.join(MODEL_DIR, "lung_model.keras")
